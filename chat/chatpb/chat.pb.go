...
var file_chat_chatpb_chat_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x4a, 0x0a, 0x04, 0x55, 0x73,
	0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02,
	0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1e, 0x0a, 0x04, 0x63, 0x68, 0x61, 0x74, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x43, 0x68, 0x61, 0x74,
	0x52, 0x04, 0x63, 0x68, 0x61, 0x74, 0x22, 0x71, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x41, 0x0a, 0x07, 0x43, 0x6f, 0x6e,
	0x6e, 0x65, 0x63, 0x74, 0x12, 0x1e, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01,
	...
	0x43, 0x6c, 0x6f, 0x73, 0x65, 0x32, 0x6b, 0x0a, 0x09, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61,
	0x73, 0x74, 0x12, 0x2e, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74, 0x72, 0x65,
	...
	0x73, 0x65, 0x42, 0x0d, 0x5a, 0x0b, 0x63, 0x68, 0x61, 0x74, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x70,
...
var file_chat_chatpb_chat_proto_goTypes = []interface{}{
	...
	(*Connect)(nil), // 3: chat.Connect
	(*Close)(nil),   // 4: chat.Close
}
var file_chat_chatpb_chat_proto_depIdxs = []int32{
	0, // 0: chat.User.chat:type_name -> chat.Chat
	1, // 1: chat.Message.user:type_name -> chat.User
	1, // 2: chat.Connect.user:type_name -> chat.User
	3, // 3: chat.Broadcast.CreateStream:input_type -> chat.Connect
	2, // 4: chat.Broadcast.BroadcastMessage:input_type -> chat.Message
	2, // 5: chat.Broadcast.CreateStream:output_type -> chat.Message
	4, // 6: chat.Broadcast.BroadcastMessage:output_type -> chat.Close
...
func file_chat_chatpb_chat_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chat_chatpb_chat_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chat_chatpb_chat_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chat_chatpb_chat_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Close); i {
			case 0:
				return &v.state
			case 1:
